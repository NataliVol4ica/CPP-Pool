...
Form::UnsignedFormException::UnsignedFormException(Form::UnsignedFormException const &ref) {*this = ref;}
Form::UnsignedFormException::~UnsignedFormException() throw() {}
Form::UnsignedFormException &Form::UnsignedFormException::operator=(Form::UnsignedFormException const &ref)
{
	exception::operator=(ref);
	return *this;
}
